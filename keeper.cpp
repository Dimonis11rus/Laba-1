...
void keeper::save_motorbike(motorbike &obj)
{
...
void keeper::read_file(car &obj_c, motorbike &obj_m, bus &obj_b, int &ii, int &car_count, int &moto_count, int &bus_count, char *str)
{
